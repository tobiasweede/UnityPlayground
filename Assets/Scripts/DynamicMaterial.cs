...
public class DynamicMaterial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // m_Renderer.material.mainTexture = UnityLogo();
        m_Renderer.material.mainTexture = ImageAsset(Application.dataPath + "/Resources/DecIS-Lab_logo.jpeg");

        m_Renderer.material.SetTexture("_secondary", UnityLogo());

        // Texture2D tex = new Texture2D(0,0,TextureFormat.ARGB32, false);
        // tex.LoadImage("DecIS-Lab_logo.jpeg");
    }

    Texture2D ImageAsset(string path)
    {
